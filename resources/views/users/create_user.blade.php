            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="{{ route('usuario.store') }}" method="POST">
                            ...
                            <div class="col-sm-offset-2 col-sm-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="accweb" id="accweb" type="checkbox" value="1">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input  class="form-check-input" name="accapp" id="accapp" type="checkbox" value="1">
                        ...
                        <center>
                            <button class="btn btn-primary" id="saveuser" name="saveuser" type="submit">
                                GUARDAR USUARIO
                            </button>
                        </center>
                    </form>
